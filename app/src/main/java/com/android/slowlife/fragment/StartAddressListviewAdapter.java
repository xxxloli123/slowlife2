...
public class StartAddressListviewAdapter extends BaseAdapter {
    private List<AddressEntity> list;
    private StartAddressActivity mContext;
    private LayoutInflater inflater;
    private boolean signChioce;

    public StartAddressListviewAdapter(StartAddressActivity mContext, List<AddressEntity> list) {
        this(mContext, list, false);
    }

    public StartAddressListviewAdapter(StartAddressActivity act, List<AddressEntity> list, boolean item) {
        this.list = list;
        this.mContext = act;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        StartAddressListviewAdapter.ViewHolder holder;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_receipt_address_listview, parent, false);
            holder = new StartAddressListviewAdapter.ViewHolder();
            ...
            holder = (StartAddressListviewAdapter.ViewHolder) convertView.getTag();
        }
