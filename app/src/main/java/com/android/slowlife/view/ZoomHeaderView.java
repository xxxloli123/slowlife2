...
public class ZoomHeaderView extends LinearLayout {
    ...
    private boolean isExpand = false,isSmall = false;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        ZoomHeaderView zoomHeader = (ZoomHeaderView)findViewById(R.id.zoomHeader);
//        zoomHeader.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                //向下移动
//                if (currentYG + moveYG > 0 && currentYG + moveYG < 800) {
//                    finish();
//                }
//            }
//        });
    ...
    private float moveYG= 0,currentYG;
