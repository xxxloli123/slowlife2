...
import com.android.slowlife.MapActivity;
...
public class DeliveryOrdersActivity extends MapActivity {
    ...
    protected void init() {
        ...
        modePaymentText.setText(oe.getPayStatus_value());
        if (oe.getPayStatusE().equals(PayStatus.UnPayed)) {
    ...
    @LayoutRes
    int getLayoutId() {
        return R.layout.activity_delivery_orders;
    }
