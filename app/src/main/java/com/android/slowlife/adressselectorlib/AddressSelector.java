package com.android.slowlife.adressselectorlib;
...
public class AddressSelector extends LinearLayout implements View.OnClickListener{
    private int TextSelectedColor = Color.parseColor("#FF0000");
    ...
    //列表文字选中的颜色
    private int listTextSelectedColor = R.color.red;
    //列表icon资源
    ...
    private void init(Context context){
        ...
        grayLine.setBackgroundColor(mContext.getResources().getColor(R.color.red));
        addView(grayLine);
    ...
    public class Tab extends TextView{
        private int index = 0;
        private int TextSelectedColor = Color.parseColor("#FF0000");
//        private int TextSelectedColor = R.color.red;
        private int TextEmptyColor = Color.parseColor("#333333");
        /**
         * 是否选中状态
         * */
